...
(function () {
    ...
    var toolbarButtonActions = {
        drawPoint: makeDrawHandler("POINT"),
        //drawLine: makeDrawHandler("LINE"),
        drawPolyline: makeDrawHandler("POLYLINE"),
        drawPolygon: makeDrawHandler("POLYGON"),
        findPath: function () {
            alert("TODO");
        },
        resetMap: function () {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (map.frontendInfo && map.frontendInfo.arcgis) {
                ...
                if (map.frontendInfo.arcgis.layers && map.frontendInfo.arcgis.layers.length) {
                    ...
                    // Make sure map layer popup is hidden
                    mapLayersPromise = loadMapLayers();
                }
            } else {
                // Make sure map layer popup is hidden
                mapLayersPromise = loadMapLayers();
    ...
    var toBeRequired = {
        ...
        "esri/dijit/analysis/ConnectOriginsToDestinations": "ConnectOriginsToDestinations"
    };
