...
sergis.main = {
    ...
    initAfterLogin: function (user) {
        ...
        if (user.displayName) {
            ...
            document.getElementById("main-header-title").setAttribute("title", "Logged in as " + user.displayName);
        }
        // Set up top-left-corner button
        if (user.homeURL) {
            document.getElementById("main-header-title-link").setAttribute("href", user.homeURL);
        }
