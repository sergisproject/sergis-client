    ...
    checkMetadata: function () {
        ...
        if (sergis.main.user.jumpingBackAllowed || sergis.main.user.jumpingForwardAllowed) {
            ...
            for (var option, i = 1; i <= sergis.main.promptCount; i++) {
                ...
                option.setAttribute("id", "navigation-promptIndex-select-option" + i);
    ...
    showPrompt: function (prompt) {
        ...
        if (sergis.main.user.jumpingBackAllowed || sergis.main.user.jumpingForwardAllowed) {
            ...
            if (!(sergis.main.user.jumpingBackAllowed && sergis.main.user.jumpingForwardAllowed)) {
                ...
                var option;
                for (i = 1; i <= sergis.main.promptCount; i++) {
                    option = document.getElementById("navigation-promptIndex-select-option" + i);
