...
if (typeof window.addEventListener == "function" &&
    ...
    document.getElementById("loading-text").innerHTML = "Please upgrade to a more modern browser.";
}
...
sergis.main = {
     ...
     *
     * @param showLoading {boolean} Whether the loading sign should be visible.
     ...
     *
     * @param choiceIndex {number} The choice index.
     */
