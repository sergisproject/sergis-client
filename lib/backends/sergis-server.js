            ...
            logIn: function (username, password) {
                return new Promise(function (resolve, reject) {
                    if (!socket) {
                        ...
                        var gameOwner = document.getElementById("sergis-backend-script").getAttribute("data-gameOwner"),
                        ...
                        socket.emit("logIn", gameOwner, gameName, username, password, function (userData, _token) {
                            if (userData && _token) {
                                token = _token;
                                resolve(userData);
            ...
            getUser: function () {
                return new Promise(function (resolve, reject) {
                    ...
                    socket.on("connect", function () {
                        ...
                        socket.emit("getUser", gameOwner, gameName, session, function (userData, _token) {
                            if (userData === false) {
                                reject();
