...
(function () {
    ...
    var fillJSON = function () {
        return new Promise(function (resolve, reject) {
            // Check if the hash contains some JSON data
            if (location.hash && location.hash.substring(0, 15) == "#jsongamedata::") {
                var gamedata = decodeURIComponent(location.hash.substring(15));
                var data;
                try {
            ...
            /*
            // Check if the query string contains some JSON data
            ...
            */
            ...
            // If we're still here, just load `testdata`.
            resolve(loadJSON("lib/testdata.json"));
        });
    };
    ...
    sergis.backend = {
        ...
        // (NOTE: These are heavily related to sergis-server/modules/client.js)
        game: {
